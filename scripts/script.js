...
function updatePanel(panelId, panelCaption, xhttp) {
    ...
    let isCdServer = serverId.indexOf("p-win-cd-02") != -1 ||
        serverId.indexOf("p-win-cd-01") != -1;
    let isDRServer = serverId.indexOf("dr-win-cd-01") != -1 ||
    serverId.indexOf("dr-win-cd-02") != -1 ;
    let statusMessage = "";
...
function loadStatus() {
    loadPage("solarwinds", "solarwinds.com", "https://www.solarwinds.com/?mira-monitoring-website");
